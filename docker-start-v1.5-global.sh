...
echo "================================================"
echo " ChuD InfiniteTalk One-Click Public V1.5       "
echo " Docker Runtime + Global Cache + hf_xet        "
echo "================================================"
echo
...
print("ChuD V1.5 runtime check: PASS")
PY

echo
echo "================================================"
echo " ChuD InfiniteTalk V1.5 READY                  "
